...
<details>
<summary><strong>Disclaimer, usage limits, and security</strong></summary>

**Terms of use.** This project uses the [GitHub Copilot SDK](https://github.com/features/copilot), subject to the [GitHub Terms of Service](https://docs.github.com/en/site-policy/github-terms/github-terms-of-service), [Copilot Product Specific Terms](https://docs.github.com/en/site-policy/github-terms/github-copilot-product-specific-terms), and [Pre-release License Terms](https://docs.github.com/en/site-policy/github-terms/github-pre-release-license-terms). It is your responsibility to ensure compliance.

**Usage limits.** Copilot SDK usage consumes your GitHub Copilot allowance. Autonomous or high-frequency usage (scheduled tasks, proactive loops) may consume it rapidly.

**Not officially supported.** This is an independent, community-built tool -- not an official GitHub product. Not endorsed by or affiliated with GitHub, Inc. or Microsoft Corporation. Use at your own risk.

**Security.** The admin UI exposes agent controls over HTTP. Use a strong `ADMIN_SECRET`, enable `LOCKDOWN_MODE` in production, and never expose the admin panel publicly without authentication.

**AI-generated content.** Agent responses are generated by AI models and may be inaccurate or inappropriate. Review output before acting on it.

**Voice calling.** Outbound calls use Azure Communication Services. Comply with all applicable telecommunications laws in your jurisdiction.

**Cost awareness.** This project can provision Azure resources (Bot Service, Communication Services, OpenAI, Key Vault, Container Apps) that incur costs on your Azure subscription.
